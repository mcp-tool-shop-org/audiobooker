...
परियोजना फ़ाइल, किसी होम निर्देशिका में नहीं, इसलिए पुन: चलाने पर **फिर से शुरू** होता है
पुस्तक को फिर से संश्लेषित करने के बजाय।

<details>
<summary>Container details — tags, the cache, and file ownership</summary>

- `latest`, `3`, `3.0` और सटीक संस्करण टैग किया गया, प्रत्येक पर जीएचसीआर पर प्रकाशित किया गया
रिलीज़।
- एंट्रीपॉइंट **`audiobooker`** है, इसलिए उप-कमांड को सीधे छवि नाम के बाद पास करें - प्रोग्राम नाम को दोहराएं नहीं।
...
**ऑडियो रेंडरिंग** को [`voice-soundboard`](https://pypi.org/project/voice-soundboard/) टीटीएस इंजन (अतिरिक्त `[render]`) और पाथ पर **एफएफएमपीईजी** (`winget install ffmpeg` · `brew install ffmpeg` · `apt install ffmpeg`) की आवश्यकता होती है। रेंडर से पहले सब कुछ - पार्स, कास्ट, कंपाइल, समीक्षा - बिना उनके काम करता है। अपने सेटअप की जांच करने के लिए `audiobooker diagnose` चलाएं।
...
इनमें से प्रत्येक एक ऐसा मामला है जहां 2.x ने कुछ स्वीकार किया और चुपचाप गलत काम किया। 3.0 इसके बजाय अस्वीकार करता है। पूरी जानकारी [चेंजलॉग](CHANGELOG.md) में।

- **आपकी पहली रेंडरिंग प्रत्येक अध्याय को एक बार फिर से रेंडर करती है।** तीन इनपुट जो ऑडियो को बदलते हैं - भावना प्रीसेट, उच्चारण तीव्रता, प्रति-चरित्र गति/पिच/जोर - कैश कुंजी से गायब थे, इसलिए प्रीसेट बदलने से "कैश्ड" रिपोर्ट किया गया और पुराना ऑडियो वापस आ गया। वे अब कुंजी में हैं, और 2.x कैश प्रविष्टि यह साबित नहीं कर सकती है कि इसने इसे कैसे उत्पन्न किया।
- **`--format m4a` अब पूरे पुस्तक के लिए एक विकल्प नहीं है।** इसका हमेशा मतलब एक प्रति अध्याय एक फ़ाइल था; `m4a` में पूरी पुस्तक के लिए पूछने से पहले एक एकल एम4बी `.m4a` नाम के तहत उत्पन्न होता था। यह अभी भी `podcast --format` पर मान्य है।
- **`render` उस पुस्तक को अस्वीकार करता है जिसके एट्रिब्यूशन में `FAILED`** लिखा है, बजाय इसके कि उस पर टीटीएस रन खर्च किया जाए। `--force` ओवरराइड करता है। `audiobooker report` चलाएं यह देखने के लिए कि यह किन पंक्तियों पर आपत्ति कर रहा है।
- **`make` अस्वीकार करता है जब परियोजना फ़ाइल पहले से मौजूद है।** इसने पहले हाथ से डाली गई आवाजों, उच्चारण ओवरराइड और संपादित शीर्षकों को एक ताज़ा ऑटो-कास्ट पार्स से बदल दिया। यदि आप यही चाहते हैं तो `--overwrite-project` पास करें।
- **`compile()` तब त्रुटि उत्पन्न करता है जब प्रत्येक अध्याय विफल हो जाता है** बजाय इसके कि एक स्वच्छ रन `None` लौटाए। यदि आप इसे पायथन से कॉल करते हैं, तो यह अब त्रुटि उत्पन्न कर सकता है।
...
### इनपुट और संरचना
- **ईपीयूबी, टीएक्सटी, मार्कडाउन, पीडीएफ, डीओसीएसएक्स**, या **प्रति-अध्याय फ़ाइलों का एक फ़ोल्डर** (स्क्रिवनर/ओब्सीडियन/क्रमबद्ध फिक्शन)।
- **टीओसी-संचालित ईपीयूबी विभाजन** - पुस्तक की अपनी तालिका सामग्री से अध्याय सीमाएं और शीर्षक।
- **डीओसीएसएक्स** वर्ड `Heading 1/2`/`Title` शैलियों पर विभाजित होता है; **पीडीएफ** शीर्षकों का पता लगाता है (स्कैन किए गए पीडीएफ गार्ड के साथ); कस्टम `--chapter-delimiter`।
- स्मार्ट टेक्स्ट क्लीनिंग, मार्कडाउन-जागरूक स्ट्रिपिंग, पाद लेख हैंडलिंग, और एक **पुन: प्रयोज्य उच्चारण शब्दकोश** (`pronunciation import/export`, सीएसवी/जेएसओएन, जिसमें फोनम पासथ्रू शामिल है)।
...
- **संवाद का पता लगाना + स्पीकर एट्रिब्यूशन** (वैकल्पिक **बुकएनएलपी** सह-संदर्भ), **उपनाम ऑटो-डिस्कवरी**, और समायोज्य **तीव्रता**, **दृश्य-स्तरीय मनोदशा** और शैली **प्रीसेट पैक** के साथ **भावना अनुमान**।
- **एट्रिब्यूशन जिसे आप ऑडिट कर सकते हैं।** प्रत्येक पंक्ति रिकॉर्ड करती है कि इसके स्पीकर का निर्णय कैसे लिया गया - एक भाषण टैग, एक इनलाइन ओवरराइड, सह-संदर्भ, आपका स्वयं का सुधार, या एक साधारण वैकल्पिक-बारी का अनुमान - और `report` उन अनुमानों को अलग से गिनता है जिन्हें वह बिल्कुल भी एट्रिब्यूट नहीं कर सका। एक अनुमान स्कोर में सुधार नहीं कर सकता है, इसलिए जब एट्रिब्यूशन बदतर हो जाता है तो संख्या कम हो जाती है, जो एकमात्र दिशा है जो उपयोगी है।
...
डब्ल्यूएवी में कोई अध्याय परमाणु नहीं है, इसलिए डब्ल्यूएवी रेंडर स्पष्ट रूप से कहता है कि ऐसा है, बजाय इसके कि विफल अध्याय मल्टीप्लेक्सिंग की रिपोर्ट की जाए - इसका उपयोग तब करें जब ऑडियो एक संपादक में जा रहा हो।
- **एसीएक्स-विशिष्ट मास्टरींग** (`--acx`) + एक **`master-check`** जो आरएमएस लाउडनेस, पीक और शोर फर्श पर पास/फेल की रिपोर्ट करता है; खुदरा **`sample`** क्लिप।
- समानांतर रेंडरिंग, एक **निरंतर रेंडर कैश** जिसमें फिर से शुरू करने की क्षमता है, गतिशील प्रगति + ईटीए, और संरचित विफलता रिपोर्ट।
...
**`master-check` भारित RMS को मापता है, LUFS नहीं।** वे अलग-अलग मात्राएँ हैं और ACX बाद वाले पर प्रतिबंध लगाता है। −20 LUFS आंकड़ा यह है कि मानकीकरण प्रक्रिया *कैसे* वहां तक पहुंचती है — यह वह है जिसे `ffmpeg loudnorm` लक्षित कर सकता है — न कि बाद में क्या जांचा जाता है।

**शोर स्तर को मापा जाता है, ठीक नहीं किया जाता।** यह वह आवश्यकता है जो सबसे अधिक विफल होती है, और यह स्रोत ऑडियो से आती है। एक उपकरण जो इसे चुपचाप सीमित करता है, वह उस एक संख्या को छिपा देगा जिसे आपको देखने की आवश्यकता है।

### जहां एक AI- द्वारा सुनाई गई ऑडियोबुक वास्तव में जा सकती है

विशिष्टताओं को पूरा करना, स्वीकार किए जाने के समान नहीं है, और यह स्पष्ट करने योग्य है: **ACX का मानक सबमिशन प्रवाह मानव कथन के लिए है।** इसकी अप्रैल 2026 की आवश्यकताओं की सूची में अनधिकृत टेक्स्ट-टू-स्पीच और AI रिकॉर्डिंग शामिल हैं, जिन्हें यह स्वीकार नहीं करता है, इसलिए एक AI- द्वारा सुनाई गई शीर्षक को सामान्य सबमिशन के बजाय ACX से पूर्व प्राधिकरण की आवश्यकता होती है।

वे मार्ग जो AI कथन को स्वीकार करते हैं, आमतौर पर प्रकटीकरण के साथ, उनमें Amazon का **वर्चुअल वॉयस** (KDP के माध्यम से, केवल Amazon वितरण) और **Spotify Audiobooks for Authors**, **Author's Republic** और **Kobo Writing Life** जैसे एग्रीगेटर शामिल हैं। इस क्षेत्र में खुदरा नीति तेजी से बदलती है — इस पैराग्राफ पर भरोसा करने के बजाय वर्तमान नियमों की स्वयं जांच करें।
...
| `preview` · `batch` · `diagnose` | वॉयस QA क्लिप · बैच/`--manifest` · पर्यावरण जांच (यदि बॉक्स रेंडर नहीं कर सकता है तो गैर-शून्य से बाहर निकलें) |
| `load <file>` | एक मौजूदा `.audiobooker` प्रोजेक्ट खोलें |
| `voices` · `chapters` · `speakers` · `speakers merge` · `info` · `status` · `cache` · `emotions` · `pronunciation` · `completion` | निरीक्षण करें और प्रबंधित करें (`speakers merge <from> <to>` डुप्लिकेट नामों को एक कास्ट स्लॉट में जोड़ता है) |
...
एक बार डिफ़ॉल्ट सेट करें, ध्वजों को बार-बार पास करने के बजाय — `.audiobookerrc` (TOML) आपकी पुस्तक के बगल में, या `[tool.audiobooker]` में `pyproject.toml`। प्राथमिकता है **CLI ध्वज > प्रोजेक्ट कॉन्फ़िगरेशन > उपयोगकर्ता कॉन्फ़िगरेशन (`~/.audiobookerrc`) > अंतर्निहित डिफ़ॉल्ट**।
...
`render(...)` और `compile(...)` एक इंजेक्ट किए गए `engine=` (किसी भी ऑब्जेक्ट को लागू करने वाला `TTSEngine` प्रोटोकॉल) और एक प्रगति कॉलबैक स्वीकार करते हैं — GUI या सेवा में ऑडियोबुकर को एम्बेड करें।
