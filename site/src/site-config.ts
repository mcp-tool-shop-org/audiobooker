  ...
  sections: [
    {
      ...
      features: [
        ...
        { title: 'Attribution you can audit', desc: 'Every line records how its speaker was decided — a speech tag, your correction, or a bare alternating-turn guess — and report counts the guesses separately. A guess cannot improve the score, so the number only moves the useful way.' },
