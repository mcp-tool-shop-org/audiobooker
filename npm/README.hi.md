...
पहली बार चलाने पर आपके उपयोगकर्ता डेटा निर्देशिका (`~/.local/share/audiobooker`, या विंडोज पर `%LOCALAPPDATA%\audiobooker`) के अंतर्गत एक प्रबंधित वर्चुअलएनवी स्थापित किया जाता है और `audiobooker-ai` स्थापित किया जाता है। उसके बाद हर बार चलाने पर यह तुरंत शुरू होता है।

**PATH पर पायथन 3.10+ की आवश्यकता है** (रैपर `python3` / `py` को ढूंढता है)। यदि यह उपलब्ध नहीं है, तो रैपर आपको बताता है कि इसे आपके ऑपरेटिंग सिस्टम के लिए कैसे स्थापित करें।
...
रेंडरिंग के लिए M4B/MP3 असेंबली के लिए PATH पर **FFmpeg** की भी आवश्यकता होती है (`winget install ffmpeg` / `brew install ffmpeg` / `apt install ffmpeg`)। अपने सेटअप की जांच करने के लिए `audiobooker diagnose` चलाएं।

## यह क्या करता है

- **बहु-आवाज कास्टिंग** जिसमें व्याख्या योग्य, रैंक की गई आवाज सुझाव शामिल हैं; `audiobooker audition <character>` आपको अंतिम रूप देने से पहले उम्मीदवार आवाजों का A/B परीक्षण करने देता है।
...
- **ACX-विशिष्ट मास्टरी**: `render --acx` ACX ऑडियो लक्ष्य के लिए मास्टरी करता है — −23 और −18 dBFS के बीच RMS, −3 पर या उससे नीचे शिखर, −60 पर या उससे नीचे शोर स्तर — और `master-check` उन तीन मापे गए सीमाओं के विरुद्ध PASS/FAIL की रिपोर्ट करता है।
ध्यान दें कि विशिष्टताओं को पूरा करना स्वीकार किए जाने के समान नहीं है: ACX का मानक सबमिशन प्रवाह मानव कथन के लिए है। AI-कथित शीर्षकों को स्वीकार करने वाले मार्गों के लिए [मुख्य README](https://github.com/mcp-tool-shop-org/audiobooker#where-an-ai-narrated-audiobook-can-actually-go) देखें।
...
| चर | प्रभाव |
|---|---|
| `AUDIOBOOKER_INSTALL_EXTRAS=render` | वॉइस इंजन के साथ प्रबंधित venv प्रदान करें (रेंडरिंग के लिए) |
